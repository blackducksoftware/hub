...
## Location of hub 4.4.0 archive:

https://github.com/blackducksoftware/hub/archive/v4.4.0.tar.gz
...
Swarm (mode), Compose, 'docker run', Kubernetes, and OpenShift are supported are supported in Hub 4.4.0. Instructions for running each can be found in the archive bundle:
