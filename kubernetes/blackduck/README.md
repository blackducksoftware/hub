...
| `imageTag` | Version of Black Duck | `2021.10.2` |
...
| `cfssl.imageTag` | Image tag to be override at container level | `1.0.4` |
...
| `uploadcache.imageTag` | Image tag to be override at container level | `1.0.19` |
...
| `logstash.imageTag` | Image tag to be override at container level | `1.0.13` |
...
| `webserver.imageTag` | Image tag to be override at container level | `2.0.9` |
