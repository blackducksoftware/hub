...
| `imageTag`                 | Version of Black Duck                                                                                                                                         | `2023.7.3` |
...
| `binaryscanner.imageTag` | Image tag to be override at container level | `2023.9.3` |
...
| `uploadcache.imageTag` | Image tag to be override at container level | `1.0.49` |
...
| `webserver.imageTag` | Image tag to be override at container level | `2.0.61` |
