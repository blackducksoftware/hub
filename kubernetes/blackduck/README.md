...
| `imageTag` | Version of Black Duck | `2022.10.0` |
...
| `binaryscanner.imageTag` | Image tag to be override at container level | `2022.9.1` |
...
| `uploadcache.imageTag` | Image tag to be override at container level | `1.0.29` |
